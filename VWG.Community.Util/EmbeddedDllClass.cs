...
{
    /// <summary>
    /// refer: https://stackoverflow.com/a/11038376
    /// 
    ...
    public class EmbeddedDllClass
    {
        ...
        public static void ExtractEmbeddedDlls(string dllName, byte[] resourceBytes)
        {
            ...
            tempFolder = System.String.Format("{0}.{1}.{2}", an.Name, an.ProcessorArchitecture, an.Version);
            ...
            #region Add the temporary dirName to the PATH environment variable (at the head!)
            ...
            #region See if the file exists, avoid rewriting it if not necessary
