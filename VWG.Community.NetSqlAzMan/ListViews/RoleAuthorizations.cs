...
{
    public partial class RoleAuthorizations : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            var cmdStoreProperties = new ToolBarButton("ManageAuthorization", ("Manage Authorization"));
            cmdStoreProperties.Image = new IconResourceHandle(GlobalVars.Theme + ".24.mdi-shield-account.png");
            cmdStoreProperties.Enabled = false;
        ...
        private void SetListView()
        {
            ...
            listView.Tag = new Guid("19FBF4DE-DEFA-4DD8-A172-15C1D8715AD0");
