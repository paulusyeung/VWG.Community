...
{
    public partial class RoleDefinition : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            ToolBarButton cmdEditRole = new ToolBarButton("EditRole", ("Edit Role Properties"));
            ...
            //toolBar.Buttons.Add(cmdDeleteRole);   唔好喺呢度 delete，因為左邊個 treeview 唔識 refresh
            #endregion
        ...
        private void SetListView()
        {
            ...
            listView.Tag = new Guid("0304035B-B362-490F-8381-6406BEDC5560");
        ...
        private void DeleteRecord()
        {
            ...
            {
                var storage = (IAzManStorage)Session["storage"];
                var item = (IAzManItem)Session["selectedObject"];
                item.Delete();
            }
            catch (Exception ex)
            {
