...
namespace VWG.Community.NetSqlAzMan.ListViews
{
    public partial class TaskDefinitions : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            var cmdEditTask = new ToolBarButton("NewTask", ("New Task"));
            cmdEditTask.Image = new IconResourceHandle(GlobalVars.Theme + ".24.mdi-folder-plus-outline.png");

            ToolBarButton cmdEditRole = new ToolBarButton("EditTask", ("Edit Task"));
            cmdEditRole.Image = new IconResourceHandle(GlobalVars.Theme + ".24.mdi-file-document-edit-outline.png");
            cmdEditRole.Enabled = false;

            ToolBarButton cmdDeleteRole = new ToolBarButton("DeleteTask", ("Delete Task"));
        ...
        private void SetListView()
        {
            ...
            listView.Tag = new Guid("0409A0CC-F4E7-4FCC-BAA3-E8BD7BC1D47E");
        ...
        private void Task_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            var form = (Forms.Definition.TaskEdit)sender;
