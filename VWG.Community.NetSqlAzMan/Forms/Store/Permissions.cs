...
namespace VWG.Community.NetSqlAzMan.Forms.Store
{
    public partial class Permissions : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            Text = "Edit Permission - " + _Store.Name;
            ...
            if (GlobalVars.Theme == "light")
            {
                lblNotes.BackColor = flpManagers.BackColor = flpUsers.BackColor = flpReaders.BackColor = Color.WhiteSmoke;
            }
            else
            {
                lblNotes.BackColor = flpManagers.BackColor = flpUsers.BackColor = flpReaders.BackColor = Color.DimGray;
            }
        ...
        private void LoadRecord()
        {
            ...
            foreach (KeyValuePair<string, bool> kvp in _Store.GetManagers())
            {
            ...
            foreach (KeyValuePair<string, bool> kvp in _Store.GetUsers())
            {
                CheckBox chk = new CheckBox()
                {
                    AutoEllipsis = true,
            ...
            foreach (KeyValuePair<string, bool> kvp in _Store.GetReaders())
            {
                CheckBox chk = new CheckBox()
                {
                    AutoEllipsis = true,
