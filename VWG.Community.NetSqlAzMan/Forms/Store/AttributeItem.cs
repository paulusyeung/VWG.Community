...
namespace VWG.Community.NetSqlAzMan.Forms.Store
{
    public partial class AttributeItem : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            switch (_Mode)
            {
                case Mode.Create:
                    ...
                    break;
                default:
                    Text = String.Format("Attribute - {0}", _Store.Name);
        ...
        {
            var item = _Store.GetAttribute(_AttributeKey);
        ...
        private void SaveRecord()
        {
            ...
            if (key != String.Empty && value != String.Empty)
            {
                ...
                {
                    case Mode.Create:
                        _Store.CreateAttribute(key, value);
                        break;
                    case Mode.Delete:
                        break;
                    case Mode.Update:
                        _Store.GetAttribute(key).Update(key, value);
                        break;
                }
