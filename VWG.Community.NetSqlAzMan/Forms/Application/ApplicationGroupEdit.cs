...
{
    public partial class ApplicationGroupEdit : Form
    {
        ...
        private List<IAzManApplicationGroupMember> _Members = new List<IAzManApplicationGroupMember>();
        private List<IAzManApplicationGroupMember> _NonMembers = new List<IAzManApplicationGroupMember>();
        ...
        private void LoadDefinition_Data()
        {
            ...
            txtGroupType.Text = _ApplicationGroup.GroupType == GroupType.Basic ? "Basic Group" : "LDAP Group";
        }
        ...
        private void LoadMember_Toolbar()
        {
            ...
            tbrMember.Buttons.Add(cmdAddApplicationGroups);
            ...
            if (!string.IsNullOrEmpty(e.Button.Name))
            {
                switch (e.Button.Name.ToLower())
                {
                    ...
                    case "addapplicationgroups":
                        var ag = new ApplicationGroupsList();
                        ag.IsMember = true;
                        ag.FormClosed += MemberApplicationGroup_FormClosed;
                        ag.ShowDialog();
                        break;
                    case "adddbusers":
        ...
        private void MemberApplicationGroup_FormClosed(object sender, FormClosedEventArgs e)
        {
            var form = (ApplicationGroupsList)sender;
            if (form.SelectedItems.Count > 0) LoadMember_Data();
        }
        ...
        private void LoadNonMember_Toolbar()
        {
            ...
            tbrNonMember.Buttons.Add(cmdAddApplicationGroups);
            ...
            if (!string.IsNullOrEmpty(e.Button.Name))
            {
                switch (e.Button.Name.ToLower())
                {
                    ...
                    case "addapplicationgroups":
                        var ag = new ApplicationGroupsList();
                        ag.IsMember = false;
                        ag.FormClosed += NonMemberApplicationGroup_FormClosed;
                        ag.ShowDialog();
                        break;
                    case "adddbusers":
                        var dbUser = new DBUsersList();
        ...
        private void NonMemberApplicationGroup_FormClosed(object sender, FormClosedEventArgs e)
        {
            var form = (ApplicationGroupsList)sender;
            if (form.SelectedItems.Count > 0) LoadNonMember_Data();
        }
