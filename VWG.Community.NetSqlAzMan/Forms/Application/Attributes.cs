...
namespace VWG.Community.NetSqlAzMan.Forms.Application
{
    public partial class Attributes : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            Text = "Attributes - " + _Application.Name;
        }
...
//            lvwAuth.DoubleClick += lvwAuth_DoubleClick;
        ...
        private void EditRecord()
        {
            if (lvwAttributes.SelectedItem != null)
            {
                ...
                var item = _Application.GetAttribute(key);
        ...
        private void DeleteRecord()
        {
            if (lvwAttributes.SelectedItem != null)
            {
                try
                {
                    ...
                    _Application.GetAttribute(key).Delete();
        ...
        private void LoadList()
        {
            ...
            IAzManAttribute<IAzManApplication>[] attributes = _Application.GetAttributes();
