...
namespace VWG.Community.NetSqlAzMan.Forms.Application
{
    public partial class AttributeItem : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            switch (_Mode)
            {
                case Mode.Create:
                    ...
                    break;
                default:
                    Text = String.Format("Attribute - {0}", _Application.Name);
        ...
        {
            var item = _Application.GetAttribute(_AttributeKey);
        ...
        private void SaveRecord()
        {
            ...
            if (key != String.Empty && value != String.Empty)
            {
                ...
                {
                    case Mode.Create:
                        _Application.CreateAttribute(key, value);
                        break;
                    case Mode.Delete:
                        break;
                    case Mode.Update:
                        _Application.GetAttribute(key).Update(key, value);
                        break;
                }
