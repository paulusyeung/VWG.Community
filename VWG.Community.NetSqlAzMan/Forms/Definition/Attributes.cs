...
namespace VWG.Community.NetSqlAzMan.Forms.Definition
{
    public partial class Attributes : Form
    {
        ...
        private void SetAttributes()
        {
            ...
            Text = "Attributes - " + _AzManItem.Name;
        }
...
//            lvwAuth.DoubleClick += lvwAuth_DoubleClick;
        ...
        private void EditRecord()
        {
            if (lvwAttributes.SelectedItem != null)
            {
                ...
                var item = _AzManItem.GetAttribute(key);
        ...
        private void DeleteRecord()
        {
            if (lvwAttributes.SelectedItem != null)
            {
                try
                {
                    ...
                    _AzManItem.GetAttribute(key).Delete();
        ...
        private void LoadList()
        {
            ...
            IAzManAttribute<IAzManItem>[] attributes = _AzManItem.GetAttributes();
