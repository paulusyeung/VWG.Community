...
namespace VWG.Community.NetSqlAzMan.Forms.Definition
{
    public partial class TaskEdit : Form
    {
        ...
        {
            IAzManItem[] members = _Task.GetMembers();
        ...
        private void Common_ListView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var cmdDelete = 
                tabControl1.SelectedIndex == 1 ? tbrTask.Buttons[tbrTask.Buttons.Count - 1] :
                tabControl1.SelectedIndex == 2 ? tbrOperation.Buttons[tbrOperation.Buttons.Count - 1] : null;
