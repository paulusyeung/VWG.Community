...
//            lvwAuth.DoubleClick += lvwAuth_DoubleClick;
        ...
        private void DeleteRecord()
        {
            if (lvwAttributes.SelectedItem != null)
            {
                try
                {
                    ...
                    _Authorization.GetAttribute(key).Delete();
        ...
        private void cmdAddNew_Click(object sender, EventArgs e)
        {
            ...
            form.AuthorizationID = _AuthorizationID;
        ...
        private void LoadList()
        {
            ...
            IAzManAttribute<IAzManAuthorization>[] attributes = _Authorization.GetAttributes();
        ...
        private int GetAuthorizationID(ListViewItem item = null)
        {
            ...
            if (lvwAttributes.SelectedItem != null)
            {
                if (item == null) item = lvwAttributes.SelectedItem;
                try
                {
