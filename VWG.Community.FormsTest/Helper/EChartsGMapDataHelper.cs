...
{
    public class EChartsGMapDataHelper
    {
        public static string GetExtraScript_China()
        {
            var result = @"
    var data = [
      {name: '海门', value: 9},
...
";
        ...
        public static string GetOption_China()
        {
      ...
      series: [
        ...
        },
        {
          ...
          zlevel: 1
            ...
            coordination.Add(112.0);
            coordination.Add(31.0);

            option.gmap = new Forms.Model.ECharts.gmap.GMap()
            {
                center = coordination,
                zoom = 5,
                roam = false,    // allow gesture
                renderOnMoving = true,
            ...
            option.series = new List<object>()
            {
                ...
                new Map()
                {
                    ...
                    coordinateSystem = CoordinateSystemType.gmap,
                    data = new ModelEx.ChartsData_GMap().DataSet2,
                    label = new Forms.Model.ECharts.style.StyleLabel()
                    {
                        formatter = "{b}",
                        position = StyleLabelType.right,
        ...
        public static string GetExtraScript_HK()
        {
            var result = @"
    var data = [
      {name: '九龍酒店', value: 9},
      {name: '尖沙咀凱悅', value: 12},
      {name: 'iSQUARE', value: 22},
      {name: '海港城', value: 32},
      {name: '佐敦中心', value: 44},
      {name: '朗豪坊', value: 55},
      {name: 'YOHO', value: 66},
    ...
    var geoCoordMap = {
      '九龍酒店':[114.1717,22.2960],
      '尖沙咀凱悅':[114.1740,22.2977],
      'iSQUARE':[114.1719,22.2971],
      '海港城':[114.1686,22.2962],
      '佐敦中心':[114.1725,22.3032],
      '朗豪坊':[114.1688,22.3187],
      'YOHO':[114.0371,22.4451],
      '新城市廣場':[114.1887,22.3807],
      '中環廣場':[114.1738,22.2801],
      '太古廣場':[114.1649,22.2774]
    };
