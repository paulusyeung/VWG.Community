            ...
            foreach (var member in sgroup.GetStoreGroupAllMembers())
            {
                ...
                switch (memberType)
                {
                    case MemberType.ApplicationGroup:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-account-supervisor-circle-outline.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-account-supervisor-circle-outline.png");
                        break;
                    case MemberType.StoreGroup:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-account-supervisor-circle.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-account-supervisor-circle.png");
                        break;
                    case MemberType.WindowsNTGroup:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-folder-account.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-folder-account.png");
                        break;
                    case MemberType.WindowsNTUser:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-folder-account-outline.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-folder-account-outline.png");
                        break;
                    case MemberType.DatabaseUser:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-account-details.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-account-details.png");
                        break;
                    case MemberType.AnonymousSID:
                    default:
                        oItem.SmallImage = new IconResourceHandle("24.mdi-account-alert-outline.png");
                        oItem.LargeImage = new IconResourceHandle("32.mdi-account-alert-outline.png");
                        break;
                }
                #endregion
