...
namespace NetSqlAzMan.Tester.NetSqlAzMan.ListViews
{
    public partial class OperationAuthorizations : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            cmdNewOperation.Image = new IconResourceHandle("24.mdi-folder-plus-outline.png");
            ...
            cmdEditOperation.Image = new IconResourceHandle("24.mdi-file-document-edit-outline.png");
        ...
        private void SetListView()
        {
            ...
            listView.Tag = new Guid("F95EA488-77BB-4282-9E89-962EF3D9A2A2");
        ...
        private void listView_Load()
        {
            ...
            foreach (var item in app.GetItems(ItemType.Operation))
            {
                ...
                #region Icon
                oItem.SmallImage = new IconResourceHandle("24.mdi-cog-outline.png");
                oItem.LargeImage = new IconResourceHandle("32.mdi-cog-outline.png");
                #endregion
