...
namespace NetSqlAzMan.Tester.NetSqlAzMan.ListViews
{
    public partial class Storage : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            cmdStorage.Image = new IconResourceHandle("24.mdi-database.png");

            toolBar.Buttons.Add(cmdStorage);

            var cmdNewStore = new ToolBarButton("NewStore", ("New Store"));
            cmdNewStore.Image = new IconResourceHandle("24.mdi-domain-plus.png");
            ...
            cmdEditStore.Image = new IconResourceHandle("24.mdi-file-document-edit-outline.png");
        ...
        private void SetListView()
        {
            ...
            listView.Tag = new Guid("9A7DE192-8EAD-4408-91EE-C435B0B46301");
                ...
                switch (e.Button.Name.ToLower())
                {
                    ...
                    case "editstore":
                        ...
                        if (listView.SelectedItem != null)
                        {
                            ...
                            var oEditStore = new Forms.Store();
        ...
        private void listView_Load()
        {
            ...
            foreach (var store in stores)
            {
                ...
                #region Icon
                oItem.SmallImage = new IconResourceHandle("24.mdi-domain.png");
                oItem.LargeImage = new IconResourceHandle("32.mdi-domain.png");
                #endregion
