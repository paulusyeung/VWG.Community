...
namespace NetSqlAzMan.Tester.NetSqlAzMan.ListViews
{
    public partial class ApplicationGroups : UserControl
    {
        ...
        private void SetToolbar()
        {
            ...
            cmdNewApplicationGroup.Image = new IconResourceHandle("24.mdi-account-multiple-plus.png");
            ...
            cmdEditApplicationGroup.Image = new IconResourceHandle("24.mdi-file-document-edit-outline.png");
        ...
        private void listView_Load()
        {
            ...
            foreach (var item in app.GetApplicationGroups())
            {
                ...
                #region Icon
                oItem.SmallImage = new IconResourceHandle("24.mdi-account-multiple.png");
                oItem.LargeImage = new IconResourceHandle("32.mdi-account-multiple.png");
                #endregion
