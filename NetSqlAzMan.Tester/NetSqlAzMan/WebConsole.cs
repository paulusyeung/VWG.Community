...
namespace NetSqlAzMan.Tester.NetSqlAzMan
{
    ...
    {
        private String _SqlConnString = @"Data Source=192.168.12.141;Initial Catalog=NetSqlAzmanStorage_Newish;Integrated Security=False;User ID=sa;Password=sa-9602;";
        ...
        private void LoadNavTree()
        {
            ...
            {
                Image = new IconResourceHandle("24.mdi-database.png"),
                Label = displayName,
                NodeFont = font,
            ...
            switch (tag)
            {
                case AzManItemType.Storage:
                    ...
                    foreach (var store in stores)
                    {
                        ...
                        {
                            Image = new IconResourceHandle("24.mdi-domain.png"),
                            Label = displayName,
                ...
                case AzManItemType.Store:
                    ...
                    {
                        Image = new IconResourceHandle("24.mdi-folder.png"),
                        Label = " Store Groups",
                        NodeFont = font4Store,
                    ...
                    foreach (IAzManApplication app in apps)
                    {
                        ...
                        {
                            Image = new IconResourceHandle("24.mdi-folder-cog-outline.png"),
                            Label = displayName,
                            NodeFont = font4Store,
                ...
                case AzManItemType.StoreGroups:
                    ...
                    foreach (IAzManStoreGroup sg in storeGroups)
                    {
                        ...
                        var iconName = sg.GroupType == GroupType.Basic ? "24.mdi-account-multiple.png" : "WindowsQueryLDAPGroup_16x16.gif";
                ...
                case AzManItemType.ApplicationGroups:
                    ...
                    {
                        var icon = ag.GroupType == GroupType.Basic ? "StoreApplicationGroup_16x16.gif" : "WindowsQueryLDAPGroup_16x16.gif";
                        tn = new TreeNode()
                        {
                            Image = new IconResourceHandle(ag.GroupType == GroupType.Basic ? "StoreApplicationGroup_16x16.gif" : "WindowsQueryLDAPGroup_16x16.gif"),
                            Label = ag.Name,
                ...
                case AzManItemType.RoleDefinitions:
                    ...
                    foreach (IAzManItem item in roleDefinitions)
                    {
                        tn = new TreeNode()
                        {
                            Image = new IconResourceHandle("24.mdi-briefcase-account.png"),
                            Label = " " + item.Name,
                ...
                case AzManItemType.TaskDefinitions:
                    ...
                    foreach (IAzManItem item in taskDefinitions)
                    {
                        tn = new TreeNode()
                        {
                            Image = new IconResourceHandle("Task_16x16.gif"),
                            Label = item.Name,
                ...
                case AzManItemType.OperationDefinitions:
                    ...
                    foreach (IAzManItem item in opDefinitions)
                    {
                        tn = new TreeNode()
                        {
                            Image = new IconResourceHandle("24.mdi-cog-outline.png"),
                            Label = " " + item.Name,
        ...
        private void LoadListView(ref TreeNode node)
        {
            ...
            TreeNode pppp = pp == null ? null : ppp.Parent;
